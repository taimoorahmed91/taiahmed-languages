...
const COMMON: Record<string, string> = {
  ...
  null: "zero (0)", eins: "one (1)", zwei: "two (2)", drei: "three (3)", vier: "four (4)", fünf: "five (5)",
  sechs: "six (6)", sieben: "seven (7)", acht: "eight (8)", neun: "nine (9)", zehn: "ten (10)",
  elf: "eleven (11)", zwölf: "twelve (12)", zwanzig: "twenty (20)", dreißig: "thirty (30)",
  vierzig: "forty (40)", fünfzig: "fifty (50)", sechzig: "sixty (60)", siebzig: "seventy (70)",
  achtzig: "eighty (80)", neunzig: "ninety (90)", hundert: "hundred (100)", tausend: "thousand (1000)",
  wahr: "true", falsch: "false / wrong", mehrfachauswahl: "multiple choice", negativ: "negative", negatives: "something negative",
  polen: "Poland", münchen: "Munich", anna: "Anna", text: "text", sätze: "sentences", satz: "sentence", gespräch: "conversation", dialog: "dialogue", nachbarin: "female neighbor", nachbarn: "neighbor (m. / plural)", "e-mail": "email",
