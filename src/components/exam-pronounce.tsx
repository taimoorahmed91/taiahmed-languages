...
const TF: TfQ[] = [
  { de: "Der Buchstabe „z“ klingt wie das englische „ts“.", statement: "The letter “z” sounds like English “ts”.", answer: true },
  { de: "Der Buchstabe „v“ klingt im Wort wie das englische „v“.", statement: "“v” in a word sounds like English “v”.", answer: false, explain: "It usually sounds like English “f”." },
  { de: "Der Buchstabe „w“ klingt wie das englische „v“.", statement: "“w” sounds like English “v”.", answer: true },
  { de: "Der Buchstabe „j“ klingt im Wort wie das englische „y“.", statement: "“j” in a word sounds like English “y”.", answer: true },
  { de: "Der Digraph „sch“ klingt wie das englische „sh“.", statement: "“sch” sounds like English “sh”.", answer: true },
  { de: "Der Diphthong „ei“ klingt wie das englische „ee“.", statement: "“ei” sounds like English “ee”.", answer: false, explain: "It sounds like English “eye”." },
  { de: "Der Diphthong „ie“ klingt wie das englische „ee“.", statement: "“ie” sounds like English “ee”.", answer: true },
  { de: "Der Diphthong „eu“ klingt wie das englische „oy“.", statement: "“eu” sounds like English “oy”.", answer: true },
  { de: "Der Umlaut „ö“ klingt genau wie ein normales „o“.", statement: "The umlaut “ö” sounds the same as plain “o”.", answer: false, explain: "It is a rounded vowel, closer to “urr”." },
  { de: "Der Buchstabe „s“ am Wortanfang klingt wie das englische „z“.", statement: "“s” at the start of a word sounds like English “z”.", answer: true },
];

const FILL: FillQ[] = [
  { de: "M___dchen", prompt: "(girl) — fill the umlaut", answer: "ä", hint: "a-umlaut" },
  { de: "sch___n", prompt: "(beautiful) — fill the umlaut", answer: "ö", hint: "o-umlaut" },
  { de: "fr___h", prompt: "(early) — fill the umlaut", answer: "ü", hint: "u-umlaut" },
  { de: "Der Digraph für den „sh“-Laut ist ___ .", prompt: "The digraph for the “sh” sound.", answer: "sch" },
  { de: "Der Diphthong, der wie „oy“ klingt, ist ___ .", prompt: "The diphthong that sounds like English “oy”.", answer: "eu" },
  { de: "Der Diphthong, der wie „eye“ klingt, ist ___ .", prompt: "The diphthong that sounds like English “eye”.", answer: "ei" },
  { de: "Der Buchstabe ___ klingt wie das englische „ts“.", prompt: "Which single letter sounds like English “ts”?", answer: "z" },
];
...
export function ExamPronounce({ onComplete }: { onComplete?: (score: number, total: number) => void }) {
    ...
    <div className="space-y-8">
      <section className="rounded-lg border border-border bg-card overflow-hidden">
        <header className="px-5 py-3 border-b border-border bg-muted/40">
          ...
          <p className="text-xs text-muted-foreground">Pair each German word with its English meaning.</p>
        </header>
