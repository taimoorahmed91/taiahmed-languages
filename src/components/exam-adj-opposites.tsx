...
const TF: TfQ[] = [
  { de: "„groß“ ist das Gegenteil von „klein“.", statement: "“groß” is the opposite of “klein”.", answer: true },
  { de: "„heiß“ und „warm“ sind Gegenteile.", statement: "“heiß” and “warm” are opposites.", answer: false, explain: "The opposite of „heiß“ is „kalt“; the opposite of „warm“ is „kühl“." },
  { de: "„wahr“ bedeutet „true“.", statement: "“wahr” means “true”.", answer: true },
  { de: "„falsch“ kann „wrong“ oder „false“ bedeuten.", statement: "“falsch” can mean “wrong” or “false”.", answer: true },
  { de: "„reich“ bedeutet „poor“.", statement: "“reich” means “poor”.", answer: false, explain: "„reich“ means rich; „arm“ means poor." },
  { de: "„leicht“ kann „light“ oder „easy“ bedeuten.", statement: "“leicht” can mean “light” or “easy”.", answer: true },
  { de: "„dumm“ und „klug“ sind Gegenteile.", statement: "“dumm” and “klug” are opposites.", answer: true },
  { de: "„jung“ ist das Gegenteil von „neu“.", statement: "“jung” is the opposite of “neu”.", answer: false, explain: "„jung“ is the opposite of „alt“ (for people); „neu“ is the opposite of „alt“ (for things)." },
];

const FILL: FillQ[] = [
  { de: "Ein Blauwal ist groß, aber eine Maus ist ___.", prompt: "opposite of „groß“.", answer: "klein" },
  { de: "Ein Kampfjet ist schnell, aber ein spazierender Mensch ist ___.", prompt: "opposite of „schnell“.", answer: "langsam" },
  { de: "Im Sommer wird's heiß und im Winter wird's ___.", prompt: "opposite of „heiß“.", answer: "kalt" },
  { de: "Im Frühling wird's warm und im Herbst wird's ___.", prompt: "opposite of „warm“.", answer: "kühl" },
  { de: "Elon Musk ist reich und der Rest von uns sind ___.", prompt: "opposite of „reich“.", answer: "arm" },
  { de: "Ein Auto ist teuer, aber ein Fahrrad ist ___.", prompt: "opposite of „teuer“.", answer: "billig" },
  { de: "Lachen ist gut, aber Stress ist ___.", prompt: "opposite of „gut“.", answer: "schlecht" },
  { de: "Lange Haare brauchen mehr Pflege als ___ Haare.", prompt: "opposite of „lang“.", answer: "kurze" },
];
...
export function ExamAdjOpposites({ onComplete }: { onComplete?: (score: number, total: number) => void }) {
    ...
    <div className="space-y-8">
      <section className="rounded-lg border border-border bg-card overflow-hidden">
        <header className="px-5 py-3 border-b border-border bg-muted/40">
          ...
          <p className="text-xs text-muted-foreground">Pair each German adjective with its English meaning.</p>
        </header>
