...
const MATCH: MatchQ[] = [
  ...
  { de: "einhundert", en: "100" },
  { de: "eine Million", en: "1,000,000" },
];

const TF: TfQ[] = [
  { de: "„sechzehn“ wird ohne „s“ geschrieben.", statement: "“sechzehn” is written without the “s”.", answer: true },
  { de: "„siebzehn“ enthält die Silbe „en“.", statement: "“siebzehn” contains the syllable “en”.", answer: false, explain: "“sieben” loses the “en” → siebzehn." },
  { de: "„einundzwanzig“ heißt 21 (Einer vor Zehner).", statement: "“einundzwanzig” means 21 (ones before tens).", answer: true },
  { de: "„dreißig“ wird mit „z“ geschrieben.", statement: "“dreißig” is written with “z”.", answer: false, explain: "It is written with “ß”: dreißig." },
  { de: "„eine Milliarde“ ist auf Englisch „million“.", statement: "“eine Milliarde” is English “million”.", answer: false, explain: "Milliarde = billion. Million = Million." },
  { de: "„null“ bedeutet 0.", statement: "“null” means 0.", answer: true },
  { de: "„zwo“ ist eine phonetische Alternative zu „zwei“.", statement: "“zwo” is a phonetic alternative for “zwei”.", answer: true },
  { de: "„eintausend“ bedeutet 100.", statement: "“eintausend” means 100.", answer: false, explain: "eintausend = 1,000. 100 is (ein)hundert." },
];

const FILL: FillQ[] = [
  { de: "13 = ___", prompt: "Write the German word for 13.", answer: "dreizehn" },
  { de: "25 = ___", prompt: "Note the reverse order (ones before tens).", answer: "fünfundzwanzig" },
  { de: "70 = ___", prompt: "Tens of seven — note missing 'en'.", answer: "siebzig" },
  { de: "60 = ___", prompt: "Tens of six — note missing 's'.", answer: "sechzig" },
  { de: "Wie ___ bist du?", prompt: "Asking someone's age (informal).", answer: "alt" },
  { de: "Ich ___ 30 Jahre alt.", prompt: "Verb 'to be' for 'I'.", answer: "bin" },
  { de: "Wie ist ___ Mobilnummer? (informal)", prompt: "Possessive 'your' (du).", answer: "deine" },
  { de: "1,000,000,000,000 = eine ___", prompt: "German word for trillion.", answer: "Billion" },
];
...
export function ExamNumbers({ onComplete }: { onComplete?: (score: number, total: number) => void }) {
    ...
    <div className="space-y-8">
      <section className="rounded-lg border border-border bg-card overflow-hidden">
        <header className="px-5 py-3 border-b border-border bg-muted/40">
          ...
          <p className="text-xs text-muted-foreground">Pair each German number word with its digits.</p>
        </header>
