...
const MATCH: MatchQ[] = [
  { de: "ich", en: "I" },
  { de: "du", en: "you (informal sing.)" },
  { de: "er", en: "he" },
  { de: "wir", en: "we" },
  { de: "ihr", en: "you (all, informal)" },
];

const TF: TfQ[] = [
  { de: "„Sie“ (großgeschrieben) ist die formelle Anrede.", statement: "“Sie” (capitalized) is the formal form of address.", answer: true },
  { de: "Der Akkusativ ist der „Wemfall“.", statement: "The accusative case is the “to whom” case.", answer: false, explain: "Accusative = “Wenfall” (whom). Dative = “Wemfall” (to whom)." },
  { de: "Für „er, sie, es“ endet das regelmäßige Verb auf „-t“.", statement: "For “er, sie, es” the regular verb ends in “-t”.", answer: true },
  { de: "„wir“ und „sie“ (Plural) benutzen die Endung „-en“.", statement: "“wir” and “sie” (plural) use the ending “-en”.", answer: true },
  { de: "„du machst“ ist die richtige Form von „machen“.", statement: "“du machst” is the correct form of “machen”.", answer: true },
  { de: "„ich gehen“ ist korrekt.", statement: "“ich gehen” is correct.", answer: false, explain: "Correct form: „ich gehe“." },
  { de: "„ihr arbeitet“ ist die richtige Form von „arbeiten“.", statement: "“ihr arbeitet” is the correct form of “arbeiten”.", answer: true },
  { de: "Das Pronomen „mich“ ist Dativ.", statement: "The pronoun “mich” is dative.", answer: false, explain: "„mich“ is accusative; „mir“ is dative." },
  { de: "„uns“ ist sowohl Akkusativ als auch Dativ von „wir“.", statement: "“uns” is both the accusative and dative form of “wir”.", answer: true },
  { de: "„hören“ bedeutet auf Englisch „to talk“.", statement: "“hören” means “to talk” in English.", answer: false, explain: "„hören“ means “to hear”. „reden“ means “to talk”." },
];

const FILL: FillQ[] = [
  { de: "ich ___ (machen)", prompt: "1st person sing. of „machen“", answer: "mache" },
  { de: "du ___ (lernen)", prompt: "2nd person sing. of „lernen“", answer: "lernst" },
  { de: "er ___ (arbeiten)", prompt: "3rd person sing. of „arbeiten“", answer: "arbeitet" },
  { de: "wir ___ (gehen)", prompt: "1st person pl. of „gehen“", answer: "gehen" },
  { de: "ihr ___ (hören)", prompt: "2nd person pl. of „hören“", answer: "hört" },
  { de: "Akkusativ von „ich“ ist ___ .", prompt: "Accusative of “ich”", answer: "mich" },
  { de: "Dativ von „wir“ ist ___ .", prompt: "Dative of “wir”", answer: "uns" },
];
...
export function Exam3({ onComplete }: { onComplete?: (score: number, total: number) => void }) {
